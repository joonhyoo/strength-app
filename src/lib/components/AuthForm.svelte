...
>
	<div class="mb-6 text-center">
		<!-- Inlined, not <img src="/favicon.svg">: this is the first screen after the
		     cold-start splash lifts, and an image that hasn't decoded yet would flash
		     a gap where the mark should be. -->
		<svg
			viewBox="0 0 24 24"
